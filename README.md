...
RTL Design: Developed using Verilog with a focus on synthesizable, low-latency logic paths suitable for high-speed hardware acceleration.
...
1. Pipelined Execution Waveforms
...
3. Hazard Analysis & Pipeline Throughput
